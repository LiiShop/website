...
<div id="info01n" align="center">
        <script language="JavaScript">if ('Notice of Discontinuation of Nintendo Wi-Fi Connection Service'.indexOf('[NEW]', 0) != -1) {document.write('<img src="/oss/oss/common/images//banner/NEW_en.gif"> ');};</script>
      </div>
      <div id="info01">
        <div nowrap align="left" class="txt_info">
          <script language="JavaScript">document.write('Notice of Discontinuation of Nintendo Wi-Fi Connection Service'.replace('[NEW]', ''));</script>
        </div>
      </div>
    ...
    <div id="info02n" align="center">
        <script language="JavaScript">if ('A new version of the Amazon Instant Video app is available!'.indexOf('[NEW]', 0) != -1) {document.write('<img src="/oss/oss/common/images//banner/NEW_en.gif"> ');};</script>
      </div>
      <div id="info02">
        <div nowrap align="left" class="txt_info">
          <script language="JavaScript">document.write('A new version of the Amazon Instant Video app is available!'.replace('[NEW]', ''));</script>
        </div>
      </div>
      <div id="infoShadow02"><img src="/oss/oss/common/images//spacer.gif" border="0" name="info02s" /></div>
      <div id="infoSpacer02"><a href="javascript:showPage('W_02.jsp?p=3')"><img src="/oss/oss/common/images//spacer.gif" width="514" height="25" border="0" onMouseDown="MM_swapImage('info02s','','/oss/oss/common/images//banner/GifA_News_Press.png',1);" onMouseUp="MM_swapImage('info02s','','/oss/oss/common/images//banner/GifA_News_Over.png',1)" onClick="snd.playSE(cSE_Decide);" onmouseover="snd.playSE( cSE_Forcus ); MM_swapImage('info02s','','/oss/oss/common/images//banner/GifA_News_Over.png',1);move_fleeze_cursor();" onMouseOut="MM_swapImage('info02s','','/oss/oss/common/images//banner/GifA_News_noAction.png',1);" /></a></div>
